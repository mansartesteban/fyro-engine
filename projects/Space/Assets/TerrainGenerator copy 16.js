...
class TerrainGenerator {
  ...
  createWater() {
    ...
    let sortedVertices = this.#verticesDatas.map((vertice, index) => ({vertice, index}))
    sortedVertices.sort((a, b) => b.vertice.altitude - a.vertice.altitude)
      for (let sortedVertice of sortedVertices) {
        ...
        for (let j = 0; j < neighbors.length; j++) {
          ...
          if (
            alt <
              this.#verticesDatas[indexOfLowest].altitude
          ) {
        ...
        if (indexOfLowest === i) {
          ...
          this.#verticesDatas[indexOfLowest].water += this.#verticesDatas[i].water||1 //+ this.#verticesDatas[i].altitude - this.#verticesDatas[indexOfLowest].altitude;
        }
    ...
    for (
      ...
      if (this.showAltitude) {
        ...
        //   color.multiplyScalar(blueFactor);
            ...
            // } else {
              color.multiplyScalar((this.#verticesDatas[i].water / maxWater + .75) / 1.75);
            // }
